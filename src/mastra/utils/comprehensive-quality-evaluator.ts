...
// メトリクス統合型
interface QualityMetricsIntegrated {
  performance: SevenDimensionQualityMetrics['performance'];
  psychological: SevenDimensionQualityMetrics['psychological'];
  externalAlignment: SevenDimensionQualityMetrics['externalAlignment'];
  internalConsistency: SevenDimensionQualityMetrics['internalConsistency'];
  socialDecisionMaking: SevenDimensionQualityMetrics['socialDecisionMaking'];
  contentQuality: SevenDimensionQualityMetrics['contentQuality'];
  ethics: SevenDimensionQualityMetrics['ethics'];
}
